### Causal Effect
A question  clinicians often ask is whether a treatment causes changes in a response of interest, or what is the **causal effect** of treatment on the response of interest. For instance, assume that we have carefully designed an exercise plan. We would like to know if following our exercise plan for three months leads to a reduced Body Mass Index (BMI). 
