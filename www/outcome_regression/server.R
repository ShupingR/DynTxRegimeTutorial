...
shinyServer(function(input, output){
  #------------------------------------------------------------------------------#
  # Outcome Regression Method displaed in UI Report                              #
  #------------------------------------------------------------------------------#
  output$report1 <- renderUI({
    includeHTML("./www/Outcome_Regression.html")})
  
  #------------------------------------------------------------------------------#
  # Case study displayed in UI Report                                            #
  #------------------------------------------------------------------------------#
  output$report2 <- renderUI({
    includeHTML("./www/Case_Study_2.html")})
  
  #------------------------------------------------------------------------------#
  # Interactive demo with user's own data                                        #
  #------------------------------------------------------------------------------#
  #-----------------------
